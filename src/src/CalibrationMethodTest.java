...
class CalibrationMethodTest {
	...
	//create a version of the calibration method
	...
	@Before
	public void setUp() {
		//create vars and initialize them for use in tests
	...
	public void testCalXYZ() {
		//test the methods involved in calculating XYZ vars
	...
	public void testCalVarXYZ() {
		//test the methods involved in calculating the VARXYZ vars
	...
	@Test
	void testCalLAB() {
		//test the methods involved in calculating the CIELAB vars
	...
	@Test
	void testCalRGB() {
		//test the methods involved in calculating the base RGB vars
		...
		//perform the operations and assert the arrays are equal
	...
	@Test
	void testCalMaxRGB() {
		//test the methods associated with the max RGB vars
		...
		//perform operation and assert arrays are equal
	...
	@Test
	void testScaleRGB() {
		//test the methods associated with scaling the RGB vars
		...
		//performs the operation and assert the arrays are equal
	...
	void testFullCalcRGB() {
		//test the all the methods associated with RGB calculations
		...
		//perform operations and assert the arrays are equal
		calMeth.setCalR(calMeth.calculateR(xyzToRGB, testX, testY, testZ));
		assertArrayEquals(calMeth.convertDTod1D(testR), calMeth.convertDTod1D(calMeth.getCalR()), 0.0001);
	...
	@Test
	void testCalDeltaE() {
		//test the methods associated with calculating the delta E vals
	...
	void testCalDeltaRGB() {
		//test the methods associated with the delta RGB var
		...
		//perform operations and assert arrays are equal using a for loop
	...
	@Test
	void testAvgDeltaE() {
		//test the method used for averaging the delta e
	...
	void testAdjustOffsets() {
		//testing the methods associated with adjusting the offset vars
		
		//create and set vars for testing purposes
		...
		//perform operations for mult offsets and assert arrays are equal
		...
		//print the offsets for check purposes
		...
		//perform operations for add offsets and assert arrays are equal
		...
		//perform operations for exp offsets and assert arrays are equal
	...
	void testConvertMethods() {
		//test methods used in conversions
